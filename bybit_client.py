...
class BybitClient:
    ...
    def wallet_balance(self, coin: str = "USDT") -> dict:
        ...
        if self.use_real:
            ...
            # The response "list" contains wallet entries, each has "coin" and balances
            ...
            try:
                ...
                used = safe_float(virtual.get("used"))
    ...
    def get_wallet_balance(self) -> dict:
        if self.use_real:
            # Use wallet_balance for real trading
            return self.wallet_balance("USDT")
        else:
            # Virtual mode: return detailed virtual wallet info
            try:
                with open("capital.json", "r") as f:
                    capital_data = json.load(f)
                virtual = capital_data.get("virtual", {})
